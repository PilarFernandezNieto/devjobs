...
<livewire:filtrar-vacantes/>
    <div class="py-12">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white shadow-sm rounden-lg p-6 divide-y divide-gray-200">
                ...
                @forelse ($vacantes as $vacante)
                    <div class="md:flex md:justify-between md:items-center py-5">
                        <div class="md:flex-1">
                            ...
                            <p class="font-bold text-xs text-gray-600">Último día para solicitar el puesto: <span class="font-normal">{{$vacante->ultimo_dia->format('d/m/Y')}}</span></p>
                        </div>
                        <div class="mt-5 md:mt-0">
                            <a class="uppercase p-3 border rounded-lg font-bold text-sm bg-indigo-500 text-white block text-center"
                                href="{{ route('vacantes.show', $vacante->id) }}">Ver Vacante</a>
                        </div>
                    </div>
                @empty
                    <p class="p-3 text-center text-sm text-gray-600">No hay vacantes todavía</p>
                @endforelse
            </div>
        </div>
    </div>
